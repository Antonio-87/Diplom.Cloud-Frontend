...
type ThandleGetStorageRequestSaga = { type: string } & {
  payload: TGetStorageRequestPayload;
};
function* handleGetStorageRequestSaga({
  payload,
}: ThandleGetStorageRequestSaga): Generator<
